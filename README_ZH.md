...
<!-- readme-locale:zh -->
<div align="center">
<img src="./public/logo.svg" alt="VaultBuilds — Borderlands 4 — Vault" width="64" height="64">
<h1>VaultBuilds — Borderlands 4 — Vault</h1>
</div>

独立的项目设计文档，适用对象： **Borderlands 4**。
...
- **单人技能场景** (Solo skill scenarios) — 规划模块，尚未实现。
- **装备测试记录** (Equipment test records) — 规划模块，尚未实现。
- **配置隔离清单** (Profile isolation checklist) — 规划模块，尚未实现。
